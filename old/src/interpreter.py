...
from src.objects import Boolean
...
class Interpreter:
    ...
    def visit_Assignment(self, node):
        ...
        if isinstance(value, Function) or isinstance(value, Method):
